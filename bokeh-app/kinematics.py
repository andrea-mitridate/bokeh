...
xi_def = interpolate.interp2d(eta_def_tab, alpha_def_tab, xi_def_tab, kind='cubic')
xi_det = interpolate.interp2d(eta_det_tab, alpha_det_tab, xi_det_tab, kind='cubic')
...
det2def = interpolate.interp1d(det2def_tab[::,0], det2def_tab[::,1], kind='cubic')
